...
const faqs = [
  {
    ...
    answer:
      "Hojswap is a House of Joshi swap and bridge interface for trading supported tokens across Ethereum, Base, Polygon, BNB Chain, Arbitrum, Optimism, Cronos, and XRP EVM.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The app lists Ethereum, Base, Cronos, XRP EVM, Polygon, BNB Chain, Arbitrum, and Optimism. Swap availability depends on routing support and liquidity for each chain.",
  },
  {

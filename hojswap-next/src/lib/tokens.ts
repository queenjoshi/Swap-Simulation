...
export const TOKENS: Token[] = [
  ...
  },
  {
    symbol: "GHST",
    name: "Aavegotchi",
    address: getAddress("0x385Eeac5cB85A38A9a07A70c73eA0eE1bC732679"),
    chainId: polygon.id,
    decimals: 18,
  },
  ...
  },
  {
    ...
    address: getAddress("0xf8589b526fdd65f7f301c605a6e04f0f1b4b3620"),
    chainId: bsc.id,
    decimals: 18,
    logo: "https://cdn.ondo.finance/tokens/logos/coinon_160x160.png",
  },
  {
    symbol: "MSTRon",
    name: "MicroStrategy (Ondo Tokenized)",
    address: getAddress("0x7313EA16493b2f55054Df0131A3A14B043ec8992"),
    chainId: bsc.id,
    decimals: 18,
    logo: "https://cdn.ondo.finance/tokens/logos/mstron_160x160.png",
  },
  {
    symbol: "TQQQon",
    name: "ProShares UltraPro QQQ (Ondo Tokenized)",
    address: getAddress("0xe42cfb20e00912409b77a602b5bdcff3c7acc5f4"),
    chainId: bsc.id,
    decimals: 18,
    logo: "https://cdn.ondo.finance/tokens/logos/tqqqon_160x160.png",
  },
  {
    symbol: "AMZNon",
    name: "Amazon (Ondo Tokenized)",
    address: getAddress("0x4553cFe1C09f37f38b12dC509F676964e392F8Fc"),
    chainId: bsc.id,
    decimals: 18,
    logo: "https://cdn.ondo.finance/tokens/logos/amznon_160x160.png",
  },
  {
    symbol: "ORCLon",
    name: "Oracle (Ondo Tokenized)",
    address: getAddress("0x03e4bd1ea53f1da84513da0319d1f03dd1bbcf93"),
    chainId: bsc.id,
    decimals: 18,
    logo: "https://cdn.ondo.finance/tokens/logos/orclon_160x160.png",
  },
  { symbol: "AAPLon", name: "Apple (Ondo Tokenized)", address: getAddress("0x390a684EF9cADE28A7AD0DFa61AB1Eb3842618c4"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/aaplon_160x160.png" },
  { symbol: "ACNon", name: "Accenture (Ondo Tokenized)", address: getAddress("0x7aF44d51d1fb88c5b74Fc71d3cba649Bb8099D14"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/acnon_160x160.png" },
  { symbol: "AMDon", name: "AMD (Ondo Tokenized)", address: getAddress("0x9f16E46c73b43BDB70861247d537bEE4eA18F639"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/amdon_160x160.png" },
  { symbol: "ARMon", name: "Arm Holdings plc (Ondo Tokenized)", address: getAddress("0x527C6436E1eAa4f2065CDE4090F798Cb5D031dD6"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/armon_160x160.png" },
  { symbol: "ASMLon", name: "ASML Holding NV (Ondo Tokenized)", address: getAddress("0xb034f6Cb52b7f2Fd5a7EeeffCa6b9aDCD6b9A6F6"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/asmlon_160x160.png" },
  { symbol: "BABAon", name: "Alibaba (Ondo Tokenized)", address: getAddress("0xd5964f3fcee8D649995AB88F04b8982539c282D2"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/babaon_160x160.png" },
  { symbol: "BAon", name: "Boeing (Ondo Tokenized)", address: getAddress("0xf21132A811Ad1A878E21Af60F64d4e690C9DaA42"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/baon_160x160.png" },
  { symbol: "COSTon", name: "Costco (Ondo Tokenized)", address: getAddress("0x34375f826fD3dD4E15F883d4F4786bB45eb705ac"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/coston_160x160.png" },
  { symbol: "CRCLon", name: "Circle Internet Group (Ondo Tokenized)", address: getAddress("0x992879Cd8ce0c312d98648875B5A8D6D042cbF34"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/crclon_160x160.png" },
  { symbol: "DASHon", name: "DoorDash (Ondo Tokenized)", address: getAddress("0x7567c2a46BCE46373b454682F3d95e6535BDe144"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/dashon_160x160.png" },
  { symbol: "EFAon", name: "iShares MSCI EAFE ETF (Ondo Tokenized)", address: getAddress("0x38B9A53bfDc5dba58a29bD6992341927C2fca637"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/efaon_160x160.png" },
  { symbol: "GOOGLon", name: "Alphabet Class A (Ondo Tokenized)", address: getAddress("0x091FC7778e6932d4009B087B191D1EE3bac5729A"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/googlon_160x160.png" },
  { symbol: "GSon", name: "Goldman Sachs (Ondo Tokenized)", address: getAddress("0x0D4f9b25F81163Fb4840BA4F434672543823000C"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/gson_160x160.png" },
  { symbol: "IAUon", name: "iShares Gold Trust (Ondo Tokenized)", address: getAddress("0xcB2a0F46f67dC4c58a316F1c008EDef5c2311795"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/iauon_160x160.png" },
  { symbol: "IEFAon", name: "iShares Core MSCI EAFE ETF (Ondo Tokenized)", address: getAddress("0x918008C3d29496C37b478b611967BeaCA365aF36"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/iefaon_160x160.png" },
  { symbol: "ITOTon", name: "iShares Core S&P Total US Stock Market ETF (Ondo Tokenized)", address: getAddress("0xcf9CAf83053213c44dd7027Db3e1E4aC98E55f8f"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/itoton_160x160.png" },
  { symbol: "LLYon", name: "Eli Lilly (Ondo Tokenized)", address: getAddress("0x341D31b2be1Fee9C00e395A62bA41837F4322EEd"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/llyon_160x160.png" },
  { symbol: "METAon", name: "Meta Platforms (Ondo Tokenized)", address: getAddress("0xD7dF5863A3e742F0c767768cDfcb63f09E0422f6"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/metaon_160x160.png" },
  { symbol: "MUon", name: "Micron Technology (Ondo Tokenized)", address: getAddress("0x8b6ACf6041A81567f012Ff6A4C6D96d5818d74bF"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/muon_160x160.png" },
  { symbol: "NVDAon", name: "NVIDIA (Ondo Tokenized)", address: getAddress("0xA9eE28C80f960B889dFbd1902055218cBa016F75"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/nvdaon_160x160.png" },
  { symbol: "NVOon", name: "Novo Nordisk (Ondo Tokenized)", address: getAddress("0x08a513779f46FFb7A34F16094a94016d010128a8"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/nvoon_160x160.png" },
  { symbol: "QQQon", name: "Invesco QQQ (Ondo Tokenized)", address: getAddress("0x0cdE6936d305d5B34667fC46425E852efd73559a"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/qqqon_160x160.png" },
  { symbol: "SLVon", name: "iShares Silver Trust (Ondo Tokenized)", address: getAddress("0x8b872732b07be325a8803CDB480D9d20B6f8d11B"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/slvon_160x160.png" },
  { symbol: "SPYon", name: "SPDR S&P 500 ETF (Ondo Tokenized)", address: getAddress("0x6a708EAD771238919D85930b5a0f10454E1C331a"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/spyon_160x160.png" },
  { symbol: "TMon", name: "Toyota (Ondo Tokenized)", address: getAddress("0xECC1299F183b6a720A6F4729Bf24F82Cd8D50828"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/tmon_160x160.png" },
  { symbol: "TSLAon", name: "Tesla (Ondo Tokenized)", address: getAddress("0x2494b603319d4D9F9715c9f4496d9E0364B59d93"), chainId: bsc.id, decimals: 18, logo: "https://cdn.ondo.finance/tokens/logos/tslaon_160x160.png" },

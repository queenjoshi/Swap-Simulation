...
export const SUPPORTED_CHAIN_IDS = [base.id, mainnet.id, cronos.id, polygon.id, bsc.id, arbitrum.id, optimism.id, avalanche.id, unichain.id, robinhood.id, zora.id] as const;
